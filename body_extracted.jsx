...
{/* ================================================================= */}
{/* 1. LUXURY FLOATING NAVBAR (HIGH-END STUDIO AESTHETIC)             */}
{/* ================================================================= */}
...
{/* Territory Badge */}
<div className="hidden xl:inline-flex items-center gap-1.5 ml-2.5 px-3 py-1 rounded-full bg-white/5 border border-white/10">
...
<a aria-current="page" className="relative font-label-md text-label-md px-3.5 py-2 rounded-xl bg-primary text-white font-semibold shadow-sm transition-all" href="#">
            Home
          </a>
<a className="font-label-md text-label-md px-3 py-2 rounded-xl text-white/80 hover:text-white hover:bg-white/5 transition-all" href="#about">
            About
          </a>
<div className="relative group">
<a className="inline-flex items-center gap-1 font-label-md text-label-md px-3 py-2 rounded-xl text-white/80 hover:text-white hover:bg-white/5 transition-all" href="#services">
<span>Services</span>
<span className="material-symbols-outlined text-[16px] transition-transform group-hover:rotate-180">expand_more</span>
</a>
</div>
<div className="relative group">
<a className="inline-flex items-center gap-1 font-label-md text-label-md px-3 py-2 rounded-xl text-white/80 hover:text-white hover:bg-white/5 transition-all" href="#projects">
<span>Projects</span>
<span className="material-symbols-outlined text-[16px] transition-transform group-hover:rotate-180">expand_more</span>
</a>
</div>
<a className="font-label-md text-label-md px-3 py-2 rounded-xl text-white/80 hover:text-white hover:bg-white/5 transition-all" href="#terrains">
            Plains &amp; Hills
          </a>
<a className="font-label-md text-label-md px-3 py-2 rounded-xl text-white/80 hover:text-white hover:bg-white/5 transition-all" href="#process">
            Process
          </a>
<a className="font-label-md text-label-md px-3 py-2 rounded-xl text-white/80 hover:text-white hover:bg-white/5 transition-all" href="#testimonials">
            Reviews
          </a>
<a className="font-label-md text-label-md px-3 py-2 rounded-xl text-white/80 hover:text-white hover:bg-white/5 transition-all" href="#consultation">
            Contact
          </a>
</nav>
{/* Right Quick Contact & Action CTA */}
...
<a className="font-bold hover:text-secondary-fixed transition-colors" href="tel:+917076423578">+91 70764 23578</a>
<a className="text-outline-variant hover:text-white transition-colors" href="tel:+918972164804">+91 89721 64804</a>
</div>
</div>
{/* Shimmer High-End Studio CTA */}
<a className="relative overflow-hidden shimmer-badge inline-flex items-center gap-2 bg-[#F59A23] hover:bg-[#ffaa3b] text-on-secondary-fixed font-label-md text-label-md px-4 sm:px-5 py-2.5 rounded-xl font-bold transition-all duration-300 shadow-[0_6px_22px_rgba(245,154,35,0.4)] group" href="#consultation">
<span className="whitespace-nowrap">Consult an Architect</span>
...
<a className="lg:hidden p-2 rounded-xl bg-white/5 text-white" href="#consultation">
...
{/* ================================================================= */}
{/* 2. ULTRA-CINEMATIC, IMMERSIVE HERO SECTION (DUAL TERRAIN)         */}
{/* ================================================================= */}
...
<div className="absolute inset-0 grid grid-cols-1 lg:grid-cols-2 pointer-events-none opacity-40 mix-blend-luminosity">
{/* Siliguri Plains Modernist Masterpiece */}
<div className="relative w-full h-full bg-cover bg-center" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuA-LzUYpcXMh5Chx6UeRfOcGJwtKKLsKd3cjlEoG5llfhdnclVxB7r_VCrTgAC9RAuTnK1hYoXU6Tn8qfYRnQN4cK3TBsTUMoHu5wc3FYU9WRSlYAP3-HuWRPLGJnkP0LGM2xc2MD42l438v9PwNDY3HiS5VjLkQIQo4VSBecQRhJSePLbUn1tz3iXQys3vErCqkTQE_n-rZ68wJ8q6GHcMRMpUbAbYK4-0OSwq04ktt9E2M1wrWDIv')" }}>
<div className="absolute inset-0 bg-gradient-to-r from-[#0a1514] via-[#0a1514]/65 to-transparent"></div>
</div>
{/* Darjeeling Himalayan Cantilever Villa */}
<div className="relative w-full h-full bg-cover bg-center" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuBUBieGDC6WrWJTpsifRi4s8h_olh7kh7b2pjhYgIO_RjmdsELp82zLY55rXVoU4TrXwkKDby9TzVzSvUiOBtnTa7PTXaq03UxUCOZYOjUX26C8Jthi3pUXKOsg98MCvHRLHwj9qBP3rJANmP5LSYWupz31oLkmbbNLz22f_E9btsHwU6BI1q_lQbc4ZB1RtZamV-9cWmFvwDyO3C5mDdSAesLHjT_JJhvmEHLiU5xtSpGvS3lXntUf')" }}>
<div className="absolute inset-0 bg-gradient-to-l from-[#0a1514] via-[#0a1514]/75 to-transparent"></div>
</div>
</div>
...
{/* ================================================================= */}
{/* 3. ELEVATED EDITORIAL ABOUT SECTION (ARCHITECTURAL STUDIO RIGOUR)  */}
{/* ================================================================= */}
...
<div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary font-label-caps text-label-caps uppercase tracking-wider mb-4">
                About High Grade Construction
              </div>
<h2 className="font-headline-xl text-headline-xl text-primary font-bold leading-tight mb-5">
                Engineering Excellence Across Every Contour of North Bengal
              </h2>
<p className="font-body-lg text-body-lg text-on-surface-variant mb-6 leading-relaxed">
                High Grade Construction Company bridges modern structural science with bespoke architectural luxury. Our dual engineering mastery tackles the deep pile foundations, subterranean damp-proofing, and high-water-table soils of the Siliguri corridor, while mastering the geotechnical rock-bolting, stepped RCC retaining cascades, and Zone-V seismic shear-wall designs demanded by the steep ridges of Darjeeling and Kalimpong.
              </p>
{/* Quote Card in warm frame */}
<div className="w-full p-6 rounded-2xl bg-surface-container-low border border-primary/15 shadow-sm mb-6 relative overflow-hidden">
<div className="absolute -right-4 -bottom-6 opacity-10 text-primary pointer-events-none">
<span className="material-symbols-outlined text-[100px]">format_quote</span>
</div>
<p className="font-subheading-editorial text-[19px] italic text-primary leading-snug mb-3">
                  “From city foundations to hillside elevations, we build with the same unyielding precision.”
                </p>
<div className="flex items-center gap-2">
<span className="w-6 h-[2px] bg-secondary-container"></span>
<span className="font-label-caps text-label-caps uppercase text-secondary font-bold tracking-widest">
                    Er. Rohan Chettri, Chief Structural Consultant
                  </span>
</div>
</div>
...
{/* ================================================================= */}
{/* 4. PLAINS VS HILLS DUAL MASTER PANELS                             */}
{/* ================================================================= */}
...
{/* ================================================================= */}
{/* 5. SERVICES: 10 ARCHITECTURAL TILES GRID                          */}
{/* ================================================================= */}
<section className="w-full py-20 lg:py-28 bg-surface text-on-surface" id="services">
<div className="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8">
<div className="text-center max-w-2xl mx-auto mb-16">
<span className="font-label-caps text-label-caps uppercase text-secondary font-bold tracking-widest block mb-2">Our 10 Core Services</span>
...
<p className="font-body-sm text-body-sm text-on-surface-variant leading-snug">
                  Bespoke 2D/3D layouts, passive daylighting, contour mapping, and statutory sanction drawings.
                </p>
</div>
</div>
<div className="group p-5 rounded-2xl bg-surface-container-lowest border border-outline-variant/30 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between">
...
<p className="font-body-sm text-body-sm text-on-surface-variant leading-snug">
                  Seismic Zone IV &amp; V certified calculations, STAAD.Pro beam-column models, and safety margins.
                </p>
</div>
</div>
<div className="group p-5 rounded-2xl bg-surface-container-lowest border border-outline-variant/30 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between">
...
<h3 className="font-headline-sm text-headline-sm text-on-surface font-bold mt-1 mb-2">Approvals &amp; Permits</h3>
<p className="font-body-sm text-body-sm text-on-surface-variant leading-snug">
                  End-to-end municipal clearance via SMC, SJDA, GTA, Fire Safety NOCs, and environmental boards.
                </p>
</div>
</div>
<div className="group p-5 rounded-2xl bg-surface-container-lowest border border-outline-variant/30 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between">
...
<h3 className="font-headline-sm text-headline-sm text-on-surface font-bold mt-1 mb-2">BOQ &amp; Estimation</h3>
<p className="font-body-sm text-body-sm text-on-surface-variant leading-snug">
                  Itemized transparent bill of quantities, micro-material scheduling, and price lock guarantees.
                </p>
</div>
</div>
<div className="group p-5 rounded-2xl bg-surface-container-lowest border border-outline-variant/30 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between">
...
<h3 className="font-headline-sm text-headline-sm text-on-surface font-bold mt-1 mb-2">Civil Construction</h3>
<p className="font-body-sm text-body-sm text-on-surface-variant leading-snug">
                  Heavy RCC framing, high-strength structural masonry, Grade-A TMT steel, and precision formwork.
                </p>
</div>
</div>
<div className="group p-5 rounded-2xl bg-surface-container-lowest border border-outline-variant/30 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between">
<div>
<div className="w-12 h-12 rounded-xl bg-surface-container flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition-colors duration-300 mb-4">
<span className="material-symbols-outlined text-[24px]">compass_calibration</span>
</div>
<span className="font-label-caps text-label-caps uppercase text-secondary font-bold">06</span>
<h3 className="font-headline-sm text-headline-sm text-on-surface font-bold mt-1 mb-2">Vastu Consultation</h3>
<p className="font-body-sm text-body-sm text-on-surface-variant leading-snug">
                  Harmonizing orientation science with clean, contemporary light-filled architectural plans.
                </p>
</div>
</div>
<div className="group p-5 rounded-2xl bg-surface-container-lowest border border-outline-variant/30 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between">
...
<h3 className="font-headline-sm text-headline-sm text-on-surface font-bold mt-1 mb-2">Interior Architecture</h3>
<p className="font-body-sm text-body-sm text-on-surface-variant leading-snug">
                  Premium cabinetry, modular fittings, acoustic wall paneling, Italian marble, and bespoke lighting.
                </p>
</div>
</div>
<div className="group p-5 rounded-2xl bg-surface-container-lowest border border-outline-variant/30 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between">
...
<h3 className="font-headline-sm text-headline-sm text-on-surface font-bold mt-1 mb-2">3D Front Elevation</h3>
<p className="font-body-sm text-body-sm text-on-surface-variant leading-snug">
                  4K hyper-realistic facade rendering, texture visualization, and dynamic dusk lighting models.
                </p>
</div>
</div>
<div className="group p-5 rounded-2xl bg-surface-container-lowest border border-outline-variant/30 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between">
...
<h3 className="font-headline-sm text-headline-sm text-on-surface font-bold mt-1 mb-2">Turnkey Projects</h3>
<p className="font-body-sm text-body-sm text-on-surface-variant leading-snug">
                  From bare land to move-in readiness with strict milestone SLAs and single-point accountability.
                </p>
</div>
</div>
<div className="group p-5 rounded-2xl bg-surface-container-lowest border border-outline-variant/30 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between">
...
<h3 className="font-headline-sm text-headline-sm text-on-surface font-bold mt-1 mb-2">Soil &amp; Geotech Survey</h3>
<p className="font-body-sm text-body-sm text-on-surface-variant leading-snug">
                  Rotary core drilling, standard penetration tests (SPT), and slope failure probability modeling.
                </p>
</div>
</div>
</div>
...
{/* ================================================================= */}
{/* 6. FEATURED PROJECTS: FILTERABLE MASONRY SHOWCASE                 */}
{/* ================================================================= */}
...
<span className="font-label-caps text-label-caps uppercase text-secondary font-bold tracking-widest block mb-2">Our Commitment</span>
<h2 className="font-headline-xl text-headline-xl text-primary font-bold mb-3">
              More Than Builders, We’re Your Partners
            </h2>
<p className="font-body-md text-body-md text-on-surface-variant">
              We reject corner-cutting and uncertain timelines. High Grade stands on six unwavering pillars that ensure total investment protection.
            </p>
</div>
...
<h3 className="font-headline-md text-headline-md text-primary font-bold mb-2">Uncompromising Quality</h3>
<p className="font-body-md text-body-md text-on-surface-variant leading-relaxed">
                Fe 550D Grade-A TMT steel, certified OPC/PPC concrete, on-site compression cube testing at every single pour with digital reports delivered directly to clients.
              </p>
</div>
<div className="p-7 rounded-2xl bg-surface-container border border-outline-variant/30 shadow-sm hover:shadow-md transition-all">
...
<h3 className="font-headline-md text-headline-md text-primary font-bold mb-2">Expert In-House Team</h3>
<p className="font-body-md text-body-md text-on-surface-variant leading-relaxed">
                Full-time registered structural engineers, architects, project supervisors, and MEP specialists on payroll. We do not gamble with unchecked third-party contractors.
              </p>
</div>
<div className="p-7 rounded-2xl bg-surface-container border border-outline-variant/30 shadow-sm hover:shadow-md transition-all">
<div className="w-12 h-12 rounded-xl bg-secondary-container/20 text-secondary flex items-center justify-center mb-5">
...
<h3 className="font-headline-md text-headline-md text-primary font-bold mb-2">Radical Transparency</h3>
<p className="font-body-md text-body-md text-on-surface-variant leading-relaxed">
                Exhaustive BOQ itemization down to the last fastener. Daily WhatsApp photo and video logs, drone progress updates, and zero hidden variance invoicing.
              </p>
</div>
<div className="p-7 rounded-2xl bg-surface-container border border-outline-variant/30 shadow-sm hover:shadow-md transition-all">
<div className="w-12 h-12 rounded-xl bg-primary-container/20 text-primary flex items-center justify-center mb-5">
...
<h3 className="font-headline-md text-headline-md text-primary font-bold mb-2">Contractual On-Time Delivery</h3>
<p className="font-body-md text-body-md text-on-surface-variant leading-relaxed">
                Our milestone execution follows critical path method (CPM) scheduling. Handover dates are locked in writing with financial milestone penalty safeguards.
              </p>
</div>
<div className="p-7 rounded-2xl bg-surface-container border border-outline-variant/30 shadow-sm hover:shadow-md transition-all">
<div className="w-12 h-12 rounded-xl bg-secondary-container/20 text-secondary flex items-center justify-center mb-5">
...
<h3 className="font-headline-md text-headline-md text-primary font-bold mb-2">Rigorous Site Safety</h3>
<p className="font-body-md text-body-md text-on-surface-variant leading-relaxed">
                Zero-tolerance hill-edge scaffolding standards, 100% PPE adherence, geotechnical fall nets, and strict compliance with national building safety codes.
              </p>
</div>
<div className="p-7 rounded-2xl bg-surface-container border border-outline-variant/30 shadow-sm hover:shadow-md transition-all">
<div className="w-12 h-12 rounded-xl bg-primary-container/20 text-primary flex items-center justify-center mb-5">
...
<h3 className="font-headline-md text-headline-md text-primary font-bold mb-2">5-Year Structural Warranty</h3>
<p className="font-body-md text-body-md text-on-surface-variant leading-relaxed">
                Every turnkey project comes with a legally bonded 5-year structural warranty, anti-seepage guarantee, and complimentary bi-annual maintenance audits.
              </p>
</div>
</div>
</div>
...
{/* ================================================================= */}
{/* 8. OUR PROCESS: 8-STEP HORIZONTAL TIMELINE                        */}
{/* ================================================================= */}
<section className="w-full py-20 lg:py-28 bg-[#0d1a19] text-white" id="process">
<div className="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8">
<div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
<div>
<span className="font-label-caps text-label-caps uppercase text-secondary-fixed font-bold tracking-widest block mb-2">The Blueprint of Execution</span>
...
<div className="flex flex-col items-start p-4 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm shadow-sm">
<div className="w-10 h-10 rounded-full bg-secondary-container text-on-secondary-container font-headline-sm text-headline-sm flex items-center justify-center font-bold mb-4 shadow-md">
                01
              </div>
<h3 className="font-headline-sm text-headline-sm text-white font-bold mb-1">Consultation</h3>
<p className="font-body-sm text-body-sm text-outline-variant leading-snug">
                Vision, lifestyle, space needs &amp; preliminary budget parameters.
              </p>
</div>
<div className="flex flex-col items-start p-4 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm shadow-sm">
<div className="w-10 h-10 rounded-full bg-secondary-container text-on-secondary-container font-headline-sm text-headline-sm flex items-center justify-center font-bold mb-4 shadow-md">
...
<h3 className="font-headline-sm text-headline-sm text-white font-bold mb-1">Site Visit</h3>
<p className="font-body-sm text-body-sm text-outline-variant leading-snug">
                Topographical slope analysis, soil test &amp; road approach survey.
              </p>
</div>
<div className="flex flex-col items-start p-4 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm shadow-sm">
<div className="w-10 h-10 rounded-full bg-secondary-container text-on-secondary-container font-headline-sm text-headline-sm flex items-center justify-center font-bold mb-4 shadow-md">
...
<h3 className="font-headline-sm text-headline-sm text-white font-bold mb-1">Design &amp; 3D</h3>
<p className="font-body-sm text-body-sm text-outline-variant leading-snug">
                2D floor plans, 3D elevation walkthroughs, &amp; Vastu alignment.
              </p>
</div>
<div className="flex flex-col items-start p-4 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm shadow-sm">
<div className="w-10 h-10 rounded-full bg-secondary-container text-on-secondary-container font-headline-sm text-headline-sm flex items-center justify-center font-bold mb-4 shadow-md">
...
<h3 className="font-headline-sm text-headline-sm text-white font-bold mb-1">BOQ &amp; Plan</h3>
<p className="font-body-sm text-body-sm text-outline-variant leading-snug">
                Itemized cost estimation and transparent milestone agreements.
              </p>
</div>
<div className="flex flex-col items-start p-4 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm shadow-sm">
<div className="w-10 h-10 rounded-full bg-secondary-container text-on-secondary-container font-headline-sm text-headline-sm flex items-center justify-center font-bold mb-4 shadow-md">
...
<h3 className="font-headline-sm text-headline-sm text-white font-bold mb-1">Approvals</h3>
<p className="font-body-sm text-body-sm text-outline-variant leading-snug">
                SMC, SJDA, GTA &amp; municipality sanction drawings clearance.
              </p>
</div>
<div className="flex flex-col items-start p-4 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm shadow-sm">
<div className="w-10 h-10 rounded-full bg-secondary-container text-on-secondary-container font-headline-sm text-headline-sm flex items-center justify-center font-bold mb-4 shadow-md">
...
<h3 className="font-headline-sm text-headline-sm text-white font-bold mb-1">Construction</h3>
<p className="font-body-sm text-body-sm text-outline-variant leading-snug">
                Supervised excavation, civil framing, MEP &amp; brickwork pours.
              </p>
</div>
<div className="flex flex-col items-start p-4 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm shadow-sm">
<div className="w-10 h-10 rounded-full bg-secondary-container text-on-secondary-container font-headline-sm text-headline-sm flex items-center justify-center font-bold mb-4 shadow-md">
...
<h3 className="font-headline-sm text-headline-sm text-white font-bold mb-1">Inspection</h3>
<p className="font-body-sm text-body-sm text-outline-variant leading-snug">
                Rigid 150-point structural, finish &amp; waterproofing quality audit.
              </p>
</div>
<div className="flex flex-col items-start p-4 rounded-xl bg-primary-container text-white shadow-sm border border-primary/40">
<div className="w-10 h-10 rounded-full bg-secondary-fixed text-on-secondary-fixed font-headline-sm text-headline-sm flex items-center justify-center font-bold mb-4 shadow-md">
                08
              </div>
<h3 className="font-headline-sm text-headline-sm text-white font-bold mb-1">Handover</h3>
<p className="font-body-sm text-body-sm text-on-tertiary-container leading-snug">
                Key ceremony, as-built documentation &amp; 5-yr warranty deed.
              </p>
</div>
</div>
</div>
...
{/* ================================================================= */}
{/* 9. CLIENT TESTIMONIALS: EDITORIAL DUAL-TERRAIN REVIEWS            */}
{/* ================================================================= */}
<section className="w-full py-20 lg:py-28 bg-surface-container-low text-on-surface" id="testimonials">
<div className="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8">
<div className="max-w-xl mb-14">
<span className="font-label-caps text-label-caps uppercase text-secondary font-bold tracking-widest block mb-2">Testimonials</span>
<h2 className="font-headline-xl text-headline-xl text-primary font-bold">What Our Clients Say</h2>
</div>
<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
<div className="p-7 rounded-2xl bg-surface-container-lowest border border-outline-variant/30 shadow-sm flex flex-col justify-between">
<div>
<div className="flex text-secondary-container gap-1 mb-5">
<span className="material-symbols-outlined text-[20px]" style="font-variation-settings: 'FILL' 1;">star</span>
<span className="material-symbols-outlined text-[20px]" style="font-variation-settings: 'FILL' 1;">star</span>
<span className="material-symbols-outlined text-[20px]" style="font-variation-settings: 'FILL' 1;">star</span>
<span className="material-symbols-outlined text-[20px]" style="font-variation-settings: 'FILL' 1;">star</span>
<span className="material-symbols-outlined text-[20px]" style="font-variation-settings: 'FILL' 1;">star</span>
</div>
<p className="font-subheading-editorial text-subheading-editorial italic text-on-surface leading-relaxed mb-6">
                  “High Grade turned our dream hillside villa into reality on a steep 40-degree slope in Darjeeling with zero hassle. Their retaining wall engineering is immaculate.”
                </p>
</div>
...
<img alt="Mr. Rohan Mehta" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuD1dtw3ub-Fim1cw5sqsSBPpS1Pr_ZRnvzxzVRIiW3qwljEjieh5fUCjwCLjj5SfR8yvbx5UIsnxUg7l1UUt469yvdqtzZRfXa3jd7CvcS8gAmnMNJ5jAvOIkOBKMOvG1Jt57LyeGiG7Gpv3vhCnRmtt0swygnd_o1mR_F_p8WK_cru4nsZiukLihUkzxF9LL9FxK7OvIgEgRushzVynCFFEUfYaoGYQVcPtDCN1TDrWfXxhXMCwa7X"/>
</div>
<div>
<div className="font-headline-sm text-headline-sm text-primary font-bold leading-tight">Mr. Rohan Mehta</div>
<div className="font-body-sm text-body-sm text-on-surface-variant">Hillside Villa Owner • Darjeeling</div>
</div>
</div>
</div>
<div className="p-7 rounded-2xl bg-surface-container-lowest border border-outline-variant/30 shadow-sm flex flex-col justify-between">
...
<p className="font-subheading-editorial text-subheading-editorial italic text-on-surface leading-relaxed mb-6">
                  “Delivered our 5-storey medical and commercial complex in Siliguri two weeks ahead of schedule. The BOQ was adhered to down to the single rupee. True professionals.”
                </p>
</div>
<div className="flex items-center gap-3.5 pt-4 border-t border-outline-variant/20">
<div className="w-12 h-12 rounded-full overflow-hidden bg-surface-container-high shrink-0">
<img alt="Dr. Anirban Roy" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAjM4md6desRKqq5qZqInGbxye4_2PXSowxp0rsjWrWp-dpPbfjVaqofjpoDucnTwPxBzCeCbSBtmLBiuh7liQgjZsSFe_WFJpwbC6FvToAaGOXhpC8D5Kvn2OZAc7z-FptHaZGwzC0UdLByV0pJ0wviucXip3ZVeeFvyY6arzufQH3BlD_s5HSHSrpVoiyf62g_uW7kFeNnOzjBz8RNYnSslWPl1EAYwqw_O13n6YLi7CpyIljpx5v"/>
</div>
<div>
<div className="font-headline-sm text-headline-sm text-primary font-bold leading-tight">Dr. Anirban Roy</div>
<div className="font-body-sm text-body-sm text-on-surface-variant">Commercial Developer • Sevoke Rd, Siliguri</div>
</div>
</div>
</div>
<div className="p-7 rounded-2xl bg-surface-container-lowest border border-outline-variant/30 shadow-sm flex flex-col justify-between">
...
<p className="font-subheading-editorial text-subheading-editorial italic text-on-surface leading-relaxed mb-6">
                  “Living in Kolkata while building our family home in Kalimpong seemed daunting. The daily video updates and total billing honesty gave us total peace of mind.”
                </p>
</div>
<div className="flex items-center gap-3.5 pt-4 border-t border-outline-variant/20">
<div className="w-12 h-12 rounded-full overflow-hidden bg-surface-container-high shrink-0">
<img alt="Mrs. Tashi Wangdi" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDHxFO7IiFyS0cP08Fbu0Kwb3P_ko3gXVpogAk6MfJgiYJixLj5RBq4qAd4XfWhKdOEwJv65XvVr8mYtU68huNeJ2Jcbg0uUql59ki6y2ZvUeVIKEfmXLrgpV-OgCBmtp7F4UM4FC5d2waCrCLiO-7UiagNkglegG7RyMThqAwEqrsqdLwSsNhnkbLGAdjxlXLOGMEr29-3qC3g9pA2Lr-dhoS0kle3kYFwSs91yni5ZD-dAaBf7WPx"/>
</div>
<div>
<div className="font-headline-sm text-headline-sm text-primary font-bold leading-tight">Mrs. Tashi Wangdi</div>
<div className="font-body-sm text-body-sm text-on-surface-variant">Boutique Residence • Kalimpong</div>
</div>
</div>
</div>
</div>
...
{/* ================================================================= */}
{/* 10. WARM CONSTRUCTION ORANGE CTA BANNER                           */}
{/* ================================================================= */}
...
<a className="inline-flex items-center gap-3 bg-primary text-white hover:bg-primary-container font-label-md text-label-md px-7 py-4 rounded-xl shadow-xl transition-all duration-300" href="#consultation">
...
{/* ================================================================= */}
{/* 11. CONTACT & CONSULTATION BOOKING MODULE                         */}
{/* ================================================================= */}
...
<form className="flex flex-col gap-4" onsubmit="event.preventDefault(); alert('Thank you! An engineer from High Grade will contact you within 4 business hours.');">
...
<select className="w-full px-4 py-3 rounded-xl bg-surface-container-low border border-outline-variant/30 text-on-surface text-body-sm focus:outline-none focus:border-primary shadow-sm" required="">
...
<select className="w-full px-4 py-3 rounded-xl bg-surface-container-low border border-outline-variant/30 text-on-surface text-body-sm focus:outline-none focus:border-primary shadow-sm">
...
<h4 className="font-headline-md text-headline-md text-primary font-bold mb-6">Regional Engineering Offices</h4>
<div className="flex flex-col gap-5 font-body-sm text-body-sm text-on-surface-variant">
<div className="flex gap-3.5">
<div className="w-9 h-9 rounded-xl bg-primary/10 text-primary flex items-center justify-center shrink-0">
<span className="material-symbols-outlined text-[18px]">apartment</span>
</div>
<div>
<div className="font-bold text-on-surface">Siliguri Head Operations</div>
<div>Sevoke Road, Near Planet Mall Corridor, Siliguri, WB 734001</div>
<div className="text-primary font-semibold mt-1">+91 70764 23578</div>
</div>
</div>
<div className="flex gap-3.5">
...
<div>
<div className="font-bold text-on-surface">Darjeeling Hills Branch</div>
<div>Mall Road, Chowrasta Ridge, Darjeeling, WB 734101</div>
<div className="text-secondary font-semibold mt-1">+91 89721 64804</div>
</div>
</div>
<div className="flex gap-3.5 pt-2 border-t border-outline-variant/20">
<div className="w-9 h-9 rounded-xl bg-surface-variant text-on-surface-variant flex items-center justify-center shrink-0">
<span className="material-symbols-outlined text-[18px]">mail</span>
</div>
<div>
<div className="font-bold text-on-surface">Dispatch &amp; Tender Desk</div>
<div>info@highgradeconstruction.com</div>
<div className="text-on-surface-variant text-[12px]">Mon – Sat: 9:00 AM – 7:30 PM</div>
</div>
</div>
</div>
</div>
...
<span className="w-2 h-2 rounded-full bg-secondary-container animate-ping"></span>
<span>14 Active Construction Sites</span>
</div>
<div className="absolute bottom-4 left-4 text-white">
<div className="font-headline-sm text-headline-sm font-bold leading-tight">North Bengal Network</div>
<div className="font-body-sm text-body-sm text-outline-variant">Serving Siliguri, Jalpaiguri, Darjeeling &amp; Kalimpong</div>
</div>
</div>
</div>
</div>
...
{/* ================================================================= */}
{/* FLOATING WHATSAPP CTA WITH PREFILLED MESSAGE                      */}
{/* ================================================================= */}
<aside className="fixed bottom-6 right-6 z-50 flex items-center">
<a className="relative flex items-center gap-3 bg-primary text-white px-4 py-3 rounded-full shadow-[0_12px_32px_rgba(0,81,75,0.45)] hover:bg-[#003d38] border border-white/20 transition-all duration-300 group" href="https://wa.me/917076423578?text=Hello%20High%20Grade%20Construction,%20I%20would%20like%20to%20consult%20an%20architect%20for%20my%20project." rel="noopener noreferrer" target="_blank">
...
<span className="font-label-md text-label-md hidden md:inline font-semibold pr-1">Chat with Engineering</span>
</a>
</aside>
{/* ================================================================= */}
{/* LUXURY ARCHITECTURAL FOOTER (DEEP EMERALD STUDIO)                 */}
{/* ================================================================= */}
<footer className="w-full bg-[#091514] text-white border-t border-white/10">
<div className="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-12">
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12">
<div className="lg:col-span-4 flex flex-col items-start">
<div className="flex items-center gap-3 mb-5">
<img alt="High Grade Construction Company" className="h-9 w-auto object-contain brightness-0 invert" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBGaNv_twtF34vcXxjteXRUO0h2CFJ7VCisW5BEMswmQg3BMlmsylSWChskGLQIUGuOMNU9NjIOpdDLzpc9KVE9EBpRg0oZzp_Ppvaa9jTeNm-BNDxh-ztxaR7qC0pazgCR_ELIJd3JA_d_hjFIXHJgW2mVzm1scPZdZLQAD8P2hnjybJ92SVpgxV8aiaVZdEYfcAugKG-Ipv9gXDxwRJidt_hjdwmNKr7lc5di3WjIp9GqcsGEwmVUdsLgehRzAEwwKQ"/>
<div className="flex flex-col">
<span className="font-headline-sm text-headline-sm text-white font-bold tracking-tight">High Grade</span>
<span className="font-label-caps text-label-caps uppercase tracking-widest text-outline-variant">Construction Company</span>
</div>
</div>
<p className="font-body-md text-body-md text-outline-variant mb-6 leading-relaxed max-w-sm">
            Building Spaces. Creating Trust. Delivering Architectural &amp; Civil Engineering Excellence across Plains &amp; Hills of North Bengal.
          </p>
<div className="flex flex-col gap-2 font-body-sm text-body-sm text-outline-variant mb-6">
<div className="flex items-center gap-2">
<span className="material-symbols-outlined text-secondary-fixed text-[18px]">location_on</span>
<span>Sevoke Road, Siliguri &amp; Mall Road, Darjeeling</span>
</div>
<div className="flex items-center gap-2">
<span className="material-symbols-outlined text-secondary-fixed text-[18px]">call</span>
<span>+91 70764 23578 / +91 89721 64804</span>
</div>
<div className="flex items-center gap-2">
<span className="material-symbols-outlined text-secondary-fixed text-[18px]">mail</span>
<span>info@highgradeconstruction.com</span>
</div>
</div>
<div className="inline-block p-3 bg-white/5 border border-white/10 rounded-xl">
<span className="font-subheading-editorial text-subheading-editorial italic text-secondary-fixed-dim">Build Today for a Better Tomorrow</span>
</div>
</div>
<div className="lg:col-span-2 flex flex-col">
<h4 className="font-headline-sm text-headline-sm text-white mb-5 font-bold">Quick Navigation</h4>
<ul className="flex flex-col gap-2.5 font-body-sm text-body-sm text-outline-variant">
<li><a className="hover:text-secondary-fixed transition-colors" href="#about">About HGCC</a></li>
<li><a className="hover:text-secondary-fixed transition-colors" href="#services">Architectural Design</a></li>
<li><a className="hover:text-secondary-fixed transition-colors" href="#terrains">Himalayan Hill Terrains</a></li>
<li><a className="hover:text-secondary-fixed transition-colors" href="#terrains">Plains &amp; Commercial</a></li>
<li><a className="hover:text-secondary-fixed transition-colors" href="#process">Engineering Process</a></li>
<li><a className="hover:text-secondary-fixed transition-colors" href="#projects">Featured Portfolio</a></li>
<li><a className="hover:text-secondary-fixed transition-colors" href="#testimonials">Client Testimonials</a></li>
<li><a className="hover:text-secondary-fixed transition-colors" href="#consultation">Contact &amp; Site Visit</a></li>
</ul>
</div>
<div className="lg:col-span-3 flex flex-col">
<h4 className="font-headline-sm text-headline-sm text-white mb-5 font-bold">Our 10 Core Services</h4>
<ul className="flex flex-col gap-2.5 font-body-sm text-body-sm text-outline-variant">
<li><a className="hover:text-secondary-fixed transition-colors" href="#services">Turnkey Civil Construction</a></li>
<li><a className="hover:text-secondary-fixed transition-colors" href="#services">Earthquake-Resilient Hill Engineering</a></li>
<li><a className="hover:text-secondary-fixed transition-colors" href="#services">Luxury Residential Architecture</a></li>
<li><a className="hover:text-secondary-fixed transition-colors" href="#services">Commercial Complexes &amp; Retail</a></li>
<li><a className="hover:text-secondary-fixed transition-colors" href="#services">Slope Stabilization &amp; Retaining Walls</a></li>
<li><a className="hover:text-secondary-fixed transition-colors" href="#services">Boutique Resort &amp; Hospitality</a></li>
<li><a className="hover:text-secondary-fixed transition-colors" href="#services">Interior Architecture &amp; Fit-Outs</a></li>
<li><a className="hover:text-secondary-fixed transition-colors" href="#services">Structural Audits &amp; Retrofitting</a></li>
<li><a className="hover:text-secondary-fixed transition-colors" href="#services">Soil &amp; Geotechnical Investigation</a></li>
</ul>
</div>
<div className="lg:col-span-3 flex flex-col">
<h4 className="font-headline-sm text-headline-sm text-white mb-5 font-bold">Engineering Dispatch</h4>
<p className="font-body-sm text-body-sm text-outline-variant mb-4 leading-relaxed">
            Receive our seasonal architectural monographs and hill engineering whitepapers directly to your inbox.
          </p>
<form className="flex flex-col gap-2 mb-6" onsubmit="event.preventDefault(); alert('Subscribed to Engineering Dispatch.');">
<input className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/15 text-white placeholder:text-outline text-body-sm focus:outline-none focus:ring-1 focus:ring-secondary-container" placeholder="Your official email address" type="email"/>
<button className="w-full bg-[#F59A23] text-on-secondary-fixed hover:bg-[#ffaa3b] font-label-md text-label-md py-3 rounded-xl transition-colors font-bold uppercase tracking-wider shadow-md" type="submit">
              Subscribe
            </button>
</form>
<div className="flex items-center gap-3 text-outline-variant">
<span className="font-label-caps text-label-caps uppercase">Network:</span>
<a className="hover:text-white transition-colors" href="#"><span className="material-symbols-outlined text-[20px]">share</span></a>
<a className="hover:text-white transition-colors" href="#"><span className="material-symbols-outlined text-[20px]">camera</span></a>
<a className="hover:text-white transition-colors" href="#"><span className="material-symbols-outlined text-[20px]">business_center</span></a>
</div>
</div>
</div>
<div className="mt-14 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-outline font-body-sm text-body-sm">
<p>© 2026 High Grade Construction Company. All rights reserved.</p>
<div className="flex items-center gap-4">
<a className="hover:text-white transition-colors" href="#">Privacy Policy</a>
<span className="text-outline-variant">•</span>
<a className="hover:text-white transition-colors" href="#">Terms of Engineering</a>
<span className="text-outline-variant">•</span>
<a className="hover:text-white transition-colors" href="#">Safety &amp; Compliance</a>
</div>
</div>
</div>
</footer>
